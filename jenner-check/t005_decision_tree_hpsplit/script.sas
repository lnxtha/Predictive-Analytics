...
/* From Analysis (2).sas: the HPSPLIT decision-tree model used to segment regions
   by consumption. The author's MODEL variable list, maxdepth/maxbranch settings
   and the seeded validation PARTITION are preserved as written. */
